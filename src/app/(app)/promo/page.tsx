      ...
      <div className="relative mx-auto h-[92vh] w-[95%]">
        ...
        <div className="absolute right-0 top-1/2 hidden -translate-y-1/2 transform px-10 md:top-2/3 md:block md:-translate-y-2/3 md:pl-20">
          <div className="flex gap-10">
            <Image
              src="https://res.cloudinary.com/dw1ltt9iz/image/upload/v1759556260/spotify-charts_dxzyy1.svg"
              alt="promo"
              width={250}
              height={250}
            />
            <Image
              src="https://res.cloudinary.com/dw1ltt9iz/image/upload/v1759556258/tiktok-chart_pthvv7.svg"
              alt="promo"
              width={250}
              height={250}
            />
